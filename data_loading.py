...
from om_idea.components.new_fleet_evolution_model import (
    # EnergyPrice,
    FleetEvolutionModel,
    FleetGrowth,
...
def create_idea_model(idea_options: IdeaOptions):
    ...
    relative_delta_rpm_wrt_gdppc = OMGroup(
        ...
        subsystems=[
            OMComponent(
                name="domestic_gdppc",
                component=GdpPerCapita(num_forecast_years=idea_options.num_years),
                inputs_map={
            ...
            OMComponent(
                ...
                component=RelativeDeltaRpmDueToGdppc(
                    num_forecast_years=idea_options.num_years,
        ...
        subsystems=[
            OMComponent(
                ...
                component=RelativeDeltaOperatingCosts(
                    num_forecast_years=idea_options.num_years,
                    indexed_reference_energy_intensity=idea_options.indexed_reference_fleet_level_energy_intensity,
                    indexed_reference_energy_price=idea_options.indexed_reference_energy_price,
                    reference_energy_costs_fraction_of_operating_costs=idea_options.reference_energy_costs_fraction_of_operating_costs,
                ),
                inputs_map={
                    "indexed_energy_intensity": IdeaCoupling.indexed_fleet_level_energy_intensity,
                    "indexed_energy_price": IdeaCoupling.indexed_fleet_level_energy_price,
                },
                outputs_map={
            ...
            OMComponent(
                ...
                component=AggregateDeltaRpm(num_forecast_years=idea_options.num_years),
                inputs_map={
            ...
            OMComponent(
                name="fleet_growth",
                component=FleetGrowth(
                    num_years=idea_options.num_years,
                    num_missions=idea_options.num_missions,
                    num_domestic_missions=idea_options.num_domestic_missions,
                    num_international_missions=idea_options.num_international_missions,
                ),
                inputs_map={
                    "domestic_asm": IdeaCoupling.domestic_asm,
                    "domestic_missions_fractions": IdeaInputs.domestic_missions_fractions,
                    "international_asm": IdeaCoupling.international_asm,
                    "international_missions_fractions": IdeaInputs.international_missions_fractions,
                },
                outputs_map={"yearly_fleet_growth": IdeaCoupling.yearly_fleet_growth},
            ),
            OMComponent(
                name="fleet_evolution",
                component=FleetEvolutionModel(
                    num_years=idea_options.num_years,
                    num_types=idea_options.num_types,
                    num_missions=idea_options.num_missions,
                    num_age_bins=idea_options.num_age_bins,
                    num_energy_carriers=idea_options.num_energy_carriers,
                ),
                inputs_map={
                    "initial_asm_fractions": IdeaInputs.initial_asm_fractions,
                    "retirement_curves": IdeaInputs.retirement_curves,
                    "yearly_fleet_growth": IdeaCoupling.yearly_fleet_growth,
                    "replacement_matrix": IdeaInputs.replacement_matrix,
                    "normalized_energy_intensity_per_aircraft": IdeaInputs.normalized_energy_intensity_per_aircraft,
                    "indexed_energy_intensity_changes_operations": IdeaInputs.indexed_energy_intensity_changes_operations,
                    "energy_carrier_breakdown_per_type": IdeaInputs.energy_carrier_breakdown_per_type,
                    "energy_price_per_energy_source": IdeaInputs.energy_price_per_energy_source,
                },
                outputs_map={
                    "asm_fractions_per_year": IdeaCoupling.asm_fractions_per_year,
                    "indexed_energy_intensity_technology": IdeaCoupling.indexed_fleet_level_energy_intensity_technology,
                    "indexed_energy_intensity": IdeaCoupling.indexed_fleet_level_energy_intensity,
                    "yearly_fleet_energy_use_breakdown": IdeaCoupling.fleet_level_energy_use_breakdown,
                    "yearly_average_energy_price": IdeaCoupling.fleet_level_energy_price,
                    "indexed_energy_price": IdeaCoupling.indexed_fleet_level_energy_price,
                },
            ),
            # OMComponent(
        ...
        subsystems=[
            ...
            OMComponent(
                ...
                component=FleetLevelQuantities(
                    num_forecast_years=idea_options.num_years,
                    initial_energy_intensity=idea_options.initial_fleet_level_energy_intensity,
                ),
                inputs_map={
                    "domestic_asm": IdeaCoupling.domestic_asm,
                    "international_asm": IdeaCoupling.international_asm,
